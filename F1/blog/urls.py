...
from blog.views import BlogMainPageView, AllPostView, SinglePostView, createPost, postCreatedConfirmation
...
urlpatterns = [
    ...
    path('create-post-confirm', postCreatedConfirmation, name='create_post_confirmation'),
