...
from stats.views import constructors, circuits, drivers, driver_results, driver_standings, upcoming_races_view, \
    constructor_standings, stats,driver_standings_chart, constructor_standings_chart
...
urlpatterns = [
    ...
    path('driver_standings_chart/', driver_standings_chart, name='driver_standings_chart'),
    path('constructor_standings_chart/', constructor_standings_chart, name='constructor_standings_chart'),
